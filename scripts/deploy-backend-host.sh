...
JAVA_OPTS_TOOLS="${JAVA_OPTS_TOOLS:--Xms96m -Xmx192m -Dspring.datasource.druid.stat-view-servlet.enabled=false}"
...
start_host_service \
  ...
  SPRING_CLOUD_NACOS_USERNAME="${NACOS_USERNAME}" \
  SPRING_CLOUD_NACOS_PASSWORD="${NACOS_PASSWORD}" \
  SPRING_DATASOURCE_DRUID_STAT_VIEW_SERVLET_ENABLED=false
